// Majick Studies V3.3.41 Guardian Core Restoration — AUTHORITATIVE MAIN APP BRIDGE
(function(){
'use strict';

const RELEASE_LABEL='Moonlit Collegium • V3.3.41';
const RELEASE_TITLE='Majick Studies — V3.3.41 Moonlit Collegium';
...
function applyReleaseBadge(){
  ...
  if(document.documentElement.dataset.majickVersion!=='3.3.41-guardian-core-restoration'){
    document.documentElement.dataset.majickVersion='3.3.41-guardian-core-restoration';
  }
}

function showRuntimeNotice(error){
  const message=String(error?.message||error||'Unknown runtime error');
  console.error('Majick V3.3.41 runtime error',error);
