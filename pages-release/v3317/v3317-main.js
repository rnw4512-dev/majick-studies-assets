// Majick Studies V3.3.39 D755 Retake Studio — AUTHORITATIVE MAIN APP BRIDGE
(function(){
'use strict';

const RELEASE_LABEL='Moonlit Collegium • V3.3.39';
const RELEASE_TITLE='Majick Studies — V3.3.39 Moonlit Collegium';
...
function applyReleaseBadge(){
  ...
  if(document.documentElement.dataset.majickVersion!=='3.3.39-d755-retake-studio'){
    document.documentElement.dataset.majickVersion='3.3.39-d755-retake-studio';
  }
}

function showRuntimeNotice(error){
  const message=String(error?.message||error||'Unknown runtime error');
  console.error('Majick V3.3.39 runtime error',error);
