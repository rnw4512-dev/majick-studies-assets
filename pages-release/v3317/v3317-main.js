// Majick Studies V3.3.40 Teacher-Focus D755 Questions — AUTHORITATIVE MAIN APP BRIDGE
(function(){
'use strict';

const RELEASE_LABEL='Moonlit Collegium • V3.3.40';
const RELEASE_TITLE='Majick Studies — V3.3.40 Moonlit Collegium';
...
function applyReleaseBadge(){
  ...
  if(document.documentElement.dataset.majickVersion!=='3.3.40-d755-teacher-focus'){
    document.documentElement.dataset.majickVersion='3.3.40-d755-teacher-focus';
  }
}

function showRuntimeNotice(error){
  const message=String(error?.message||error||'Unknown runtime error');
  console.error('Majick V3.3.40 runtime error',error);
