...
if progress.exists():
    ...
    data["version"]="V3.3.35 WGU Practice Bank Fix"
    data["learning_intelligence"]="V3.3.35 WGU Practice Bank Fix with protected lifetime Majick XP, official D772 Section 1 terminology, select-and-submit WGU-style practice, visual graph questions, answer-choice coaching, 30-question mixed OA simulation, concept readiness results, forced stale-mission replacement, self-populating D772 practice bank, contextual Tutor help, and universal Back navigation"
