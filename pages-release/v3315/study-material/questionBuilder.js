...
const D772_WGU_CHECKS=[
  ...
  d772Item(3,'truncated axis',3,'A bar graph compares values of 94% and 96%, but the vertical axis begins at 92%, making the bars appear dramatically different. What is the main problem with the display?',['The truncated axis exaggerates the difference','The use of a 3-D perspective distorts the display','The sample size is too small to support the graph','The data were duplicated'],'The truncated axis exaggerates the difference','WGU is testing whether the graph creates a misleading visual impression.','Read the scale before judging the size of a difference.'),
  d772Item(3,'sample size',3,'A study of six participants finds the same outcome for all six and then claims the result applies to the entire population. Which change would most directly improve the study?',['Increase the sample size','Use a different sampling frame','Add a placebo group','Use a double-blind design'],'Increase the sample size','WGU is testing the effect of small sample size on random variation.','A very small sample can produce extreme results by chance.'),
  ...
  d772Item(3,'fabrication',3,'A researcher creates survey responses for participants who never existed. Which research-integrity problem occurred?',['Fabricating data sets','Altering existing data','Intentionally omitting relevant data','Duplicating data'],'Fabricating data sets','WGU is testing fabrication versus falsification.','The observations were invented rather than collected.'),
  d772Item(3,'intentional omission',4,'A researcher removes a valid trial only because the result weakens the preferred conclusion. Which research-integrity problem occurred?',['Intentional omission of relevant data','Legitimate data exclusion','Fabricating data sets','Duplicating data'],'Intentional omission of relevant data','WGU is testing legitimate exclusion versus falsification.','The data were removed because they were inconvenient, not because of a valid rule.'),
  ...
  d772Item(4,'confounding variable',4,'An observational study finds that people who use more sunscreen also have higher rates of skin cancer. Which factor could be a confounding variable?',['Sun exposure','Age of the participants','Brand of sunscreen used','Method used to display the results'],'Sun exposure','WGU is testing whether a third variable could be associated with both the explanatory and response variables.','Sun exposure can increase sunscreen use and skin-cancer risk.'),
...
D772_WGU_CHECKS.push(
  ...
  d772Item(4,'outlier',2,'Most points in a scatterplot follow a clear pattern, but one point lies far from the rest. What is that point called?',['Outlier','Confounding variable','Response variable','Explanatory variable'],'Outlier','WGU is testing scatterplot terminology. An outlier lies noticeably away from the overall pattern.','One unusual point does not automatically mean the data are wrong.')
);
