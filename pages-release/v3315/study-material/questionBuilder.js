...
const D772_SCENARIO_BANK=[
  ...
  d772Item(1,'random sampling vs. assignment',3,'A study randomly selects people from a city and then randomly assigns those selected people to treatment groups. Which statement is correct?',['Both steps are random sampling','Both steps are randomization','Selection is random sampling; group placement is randomization (random assignment)','Selection is randomization; group placement is random sampling'],'Selection is random sampling; group placement is random assignment','WGU is testing two different uses of randomness. Sampling determines who enters the study; assignment determines which treatment group they enter.','Random sampling = WHO. Random assignment = WHERE.'),
